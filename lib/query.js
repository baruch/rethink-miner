...
var Query = {
  ...
  pageData: function(params, callback) {
    db.onConnect(function (err, conn, conncb)  {
      ...
      doQuery(conn, query.name, query.query, query.fields, params.order_by, params.page_num, params.page_size, function(err, result) {
        callback(err, result);
        conncb();
      });
    });
  ...
  save: function(callback) {
    db.onConnect(function (err, conn, conncb) {
      r.table('queries').insert({name: this.name, query: this.query, fields: this.fields}).run(conn, function(err, result) {
        conncb();
        callback(err, result);
      });
    });
